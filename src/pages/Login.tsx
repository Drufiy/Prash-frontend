...
export default function Login() {
  ...
  useEffect(() => {
    ...
    if (error === 'auth_failed') toast.error('Sign-in failed. Please try again.')
    if (error === 'no_code') toast.error('No OAuth code received from GitHub.')
      ...
      <div className="w-full max-w-sm space-y-8">
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-8 space-y-6">
          <div className="space-y-1 text-center">
            <h1 className="text-xl font-semibold text-zinc-100">Sign in to Drufiy</h1>
            <p className="text-zinc-500 text-sm">Connect your GitHub to get started.</p>
          </div>
